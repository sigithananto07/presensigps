    ...
    <div id="rekappresensi">
        ...
        <div class="row">
            <div class="col-3">
                <div class="card">
                    <div class="card-body text-center" style="padding : 12px 12px !important">
                        <span class="badge bg-danger" style="position: absolute; top:3px; right:10px; font-size:0.8rem; z-index:999">{{  $rekappresensi->jmlhadir }}</span>
            ...
            <div class="col-3">
                <div class="card">
                    <div class="card-body text-center" style="padding : 12px 12px !important">
                        <span class="badge bg-danger" style="position: absolute; top:3px; right:10px; font-size:0.8rem; z-index:999">{{ $rekapizin->jmlizin }}</span>
            ...
            <div class="col-3">
                <div class="card">
                    <div class="card-body text-center" style="padding : 12px 12px !important">
                        <span class="badge bg-danger" style="position: absolute; top:3px; right:10px; font-size:0.8rem; z-index:999">{{ $rekapizin->jmlsakit }}</span>
            ...
            <div class="col-3">
                <div class="card">
                    <div class="card-body text-center" style="padding : 12px 12px !important">
                        <span class="badge bg-danger" style="position: absolute; top:3px; right:10px; font-size:0.8rem; z-index:999">{{  $rekappresensi->jmlterlambat }}</span>
