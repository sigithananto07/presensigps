            ...
            <div class="col-12">
                <div class="card">
                     ...
                     <div class="row">
                          ...
                          <div class="row">
                              <div class="col-12">
                                 <a href="#" class="btn btn-primary" id="btnTambahCabang"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-plus" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                       ...
                                       <tr>
                                           ...
                                           <td>
                                            <div class="btn-group">
                                              ...
                                              <form action="/cabang/{{ $d->kode_cabang }}/delete" method="POST" style="margin-left:8px">
                                                @csrf
